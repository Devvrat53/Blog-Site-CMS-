        ...
        foreach($_POST['checkBoxArray'] as $postValueId) {
            ...
            switch($bulk_options) {
                ...
                case 'published':
                        ...
                        check_query($update_to_published_status); //code in 'functions.php' file
                    break;
                // Draft query
                case 'draft':
                        $query = "UPDATE posts SET post_status = '{$bulk_options}' WHERE post_id = {$postValueId}";
                        $update_to_draft_status = mysqli_query($connection, $query);
                        check_query($update_to_draft_status); //code in 'functions.php' file
                    break;
                // Delete query  
                case 'delete':
                        $query = "DELETE FROM posts WHERE post_id = {$postValueId}";
                        $update_to_delete_status = mysqli_query($connection, $query);
                        check_query($update_to_delete_status); //code in 'functions.php' file
                    break;
       ...
       <div class="col-xs-4">
        ...
        <tbody>
            ...
            while($row = mysqli_fetch_assoc($select_posts)){
                ...
                echo "<td><img src = '../images/{$post_image}' alt = 'image' height = 50 width = 120></td>";
